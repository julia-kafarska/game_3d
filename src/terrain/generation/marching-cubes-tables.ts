...
// Based on Paul Bourke's implementation: http://paulbourke.net/geometry/polygonise/

/**
 * Edge table: For each of the 256 possible cube configurations,
 * this table indicates which edges are crossed by the isosurface.
 * Each entry is a 12-bit number where bit N indicates edge N is crossed.
 *
 * Edge numbering:
...
/**
 * Triangle table: For each of the 256 cube configurations,
 * this table contains the list of triangles to generate.
 * Each entry is an array of edge indices (in groups of 3) that form triangles.
...
/**
 * Edge vertex indices: For each of the 12 edges, the two vertex indices that form it.
 * Used for edge interpolation.
 */
 ...
 * Used to get the position of each corner of the cube.
 *
 *        4-------5
 *       /|      /|
 *      / |     / |
